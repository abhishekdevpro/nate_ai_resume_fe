...
import { setAdmin } from "../../state/reducer/userNameSlice";
const AdminProfile = () => {
  ...
  const handleChangePasswordSubmit = (e) => {
    ...
    axios({
      method: "PUT",
      url: "https://api.resumesquad.net/api/admin/change-password",
      headers: {
        Authorization: token,
      },
      data: reqBody,
  ...
  useEffect(() => {
    dispatch(setAdminActiveTab("my-profile"));
  }, []);
  return (
    <div>
      <DashboardLayout>
        <div className="w-full sm:h-screen overflow-y-scroll hide-scrollbar flex flex-col  items-center justify-center">
          <div className="p-[15px] w-full ">
            <h1 className="text-white font-bold text-[25px]">User Profile</h1>
          </div>
