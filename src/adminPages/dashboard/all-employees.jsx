    ...
    <div>
      <DashboardLayout>
        <div className="w-full flex h-screen flex-col gap-[20px] ">
          <h2 className="text-white font-bold text-[25px]">All Employees</h2>
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* <td className="pl-5">
                              <div className="flex items-center">
                                <p className="text-sm leading-none text-gray-600 ml-2">
                                  {item.resume_status.name}
                                </p>
                              </div>
                            </td> */}
                            <td className="">
                              <Link
                                to={`/admin/view-individual-employee/${item?.Employee?.id}`}
                              >
                              ...
                              {/* <Link
                                to={`/admin/employee-performance-report/${item?.Employee?.id}`}
                              >
                                <button className="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-200 rounded hover:bg-gray-200 focus:outline-none">
                                  View
                                </button>
