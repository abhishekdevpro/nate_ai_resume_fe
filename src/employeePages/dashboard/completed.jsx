...
const Completed = () => {
  ...
  useEffect(() => {
    dispatch(setEmployeeSidebar("completed"));
  }, []);
  ...
  const getResume = async () => {
    await axios({
      url: "https://api.resumesquad.net/api/employee/get-resume?resume_status_id=7",
      method: "GET",
      headers: {
        Authorization: token,
      },
    ...
    <div>
      ...
      <DashboardLayout>
        <div className="w-full flex h-screen flex-col gap-[20px] ">
          <h2 className="text-white font-bold text-[25px]">Completed</h2>
