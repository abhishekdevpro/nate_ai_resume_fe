...
const ResumeAllottedManualEdit = () => {
  ...
  const getResume = async () => {
    await axios({
      url: "https://api.resumesquad.net/api/admin/get-resume?resume_status_id=8",
      method: "GET",
      headers: {},
    })
      .then((res) => {
      ...
      <DashboardLayout>
        <div className="w-full flex h-screen flex-col gap-[20px] ">
          <h2 className="text-white font-bold text-[25px]">
            Resume Allotted For Manual Edit
          </h2>
...
export default ResumeAllottedManualEdit;
