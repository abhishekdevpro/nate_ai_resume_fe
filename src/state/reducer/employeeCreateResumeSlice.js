...
const employeeCreateResumeSlice = createSlice({
  name: "employeeCreateResumeSlice",
  initialState,
  reducers: {
...
export const {
  ...
  deleteCertification,
} = employeeCreateResumeSlice.actions;

export default employeeCreateResumeSlice.reducer;
