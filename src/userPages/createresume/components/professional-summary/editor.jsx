...
import { ProfileSummaryTextEditor } from "../../../common/textEditor";
...
const ProfessionalSummary = () => {
  ...
  const jobTitle = useSelector(
    (state) => state?.createResumeSlice?.personalInfoValues?.jobTitle
  );
  ...
  return (
    <div className="w-full my-7 text-[12px] flex flex-col gap-5">
      ...
      <div className="w-full h-[180px] mb-[100px] sm:mb-[50px]">
        <ProfileSummaryTextEditor />
      </div>
    </div>
  );
};
