...
const Resume3 = () => {
  ...
  const certificationData = useSelector(
    (state) => state.createResumeSlice.certificationData
  );
  ...
  return (
    <div className="h-full bg-white min-h-[846px] overflow-y-scroll hide-scrollbar w-[600px] flex flex-col fira-sans-font gap-[12px] sm:text-[11px] text-[10px] p-[20px]">
      ...
      {textEditorValue ? <p>{textEditorValue}</p> : null}
        ...
        <div className="flex flex-col gap-[7px]">
          ...
          <div className="flex flex-wrap gap-[7px]">
            {skillsData.map((item, index) => {
              return (
                <p className="font-medium w-[30%]" key={index}>
                  {item}
                </p>
              );
            })}
      ...
      {certificationData[0] ? (
        <div className="flex flex-col gap-[7px]">
          <h2 className="text-[12px] font-semibold">Certifications</h2>
          <div className="flex flex-wrap gap-[7px]">
