...
import { setCustomerLoginValues } from "../../state/reducer/customerLoginSlice";
...
const CustomerLogin = () => {
  ...
  const CustomerLoginValues = useSelector(
    (state) => state.customerLogin.customerLoginValues
  );
  const handleChange = (e) => {
    const { name, value } = e.target;
    dispatch(setCustomerLoginValues({ ...CustomerLoginValues, [name]: value }));
  };
  const handleSubmit = async (e) => {
    const reqBody = {
      email: CustomerLoginValues.email,
      password: CustomerLoginValues.password,
    };
    e.preventDefault();
    await axios({
      method: "POST",
      url: "https://api.resumesquad.net/api/user/auth/login",
      headers: {
            ...
            <div className="flex flex-col my-2 gap-2 w-full items-center">
              <div className="flex flex-col gap-2 w-[90%]">
                ...
                <input
                  ...
                  id="email"
                  autoComplete="false"
                  value={CustomerLoginValues.email}
              ...
              <div className="flex flex-col gap-2 w-[90%]">
                ...
                <div className="w-full bg-white flex items-center px-2 py-2 rounded-md">
                  <input
                    ...
                    id="password"
                    autoComplete="false"
                    value={CustomerLoginValues.password}
                    onChange={handleChange}
              ...
              <Link to="/user/forgot-password" className="w-[90%]">
